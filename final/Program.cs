    ...
    if (flag)
    {
        ...
        switch (choice)
        {
            ...
            case 4:
                ...
                Console.WriteLine(s.Name + " has been assigned to " + c11.CourseName);
                c11 = null;
                s = null;
            ...
            case 5:
                ...
                Console.WriteLine(t.Name + " has been assigned to " + c.CourseName);
...
void Teacher()
{
    ...
    if (flag)
    {
        ...
        foreach (var course in tempCourse2.StudentAttendance)
        {
            ...
            var stu = context.students.Where(x => x.Id == course.StudentID).FirstOrDefault();
            Console.WriteLine("Student Name: " + stu.Name + "| Course Name: " + course.course.CourseName + "| Class Date: " + course.date + "| Present status: " + course.present);

        }

        //course.StudentID.ToString()
...
void Student()
{
    ...
    if (flag)
    {
        ...
        tempCourse2.StudentAttendance.Add(new Attendance { course = tempCourse2, student = t, date = DateTime.Now, present = true });
        ...
        t = null; t2 = null; tempCourse2 = null;
